...
final class ScheduleRepository
{
    ...
    private function matchScope(int $userId, string $scope): array
    {
        ...
        if ($scope === 'championship') return ["EXISTS (SELECT 1 FROM championship_user_assignments cua WHERE cua.championship_id = m.championship_id AND cua.user_id = ? AND cua.assignment_type = 'organizer')", [$userId]];
