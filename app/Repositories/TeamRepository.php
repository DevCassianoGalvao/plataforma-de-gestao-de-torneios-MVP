...
final class TeamRepository
{
    ...
    private function scopeSql(int $userId, string $scope, bool $mutation): array
    {
        ...
        if ($scope === 'organizer') {
            return ['EXISTS (SELECT 1 FROM championship_user_assignments cua WHERE cua.championship_id = t.championship_id AND cua.user_id = ? AND cua.assignment_type = \'organizer\')', [$userId]];
        }
