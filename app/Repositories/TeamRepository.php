...
final class TeamRepository
{
    ...
    public function listForUser(int $userId, string $scope, array $filters = []): array
    {
        ...
        $sql = 'SELECT t.*, c.name AS championship_name, c.slug AS championship_slug, c.requires_guardian, c.allow_underage_athletes, cat.name AS category_name, cat.minimum_age, cat.maximum_age, cat.gender_rule, s.name AS season_name, f.name AS formation_name, '
            . 'COALESCE('
