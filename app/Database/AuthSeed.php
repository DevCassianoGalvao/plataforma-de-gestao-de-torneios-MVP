...
final class AuthSeed
{
    public static function run(PDO $pdo, string $password): void
    {
        ...
        $rolePermissions = [
            ...
            'organizer' => ['championships.view', 'championships.manage', 'championships.create', 'championships.update', 'championships.manage_identity', 'seasons.view', 'categories.view', 'regulations.view', 'regulations.create', 'regulations.update', 'regulations.publish', 'regulations.version_history', 'teams.view', 'teams.manage', 'athletes.view', 'registrations.review', 'matches.view', 'matches.homologate', 'content.manage', 'content.publish', 'transfers.manage'],
