...
<div class="app-shell">
    <aside id="app-sidebar" class="app-sidebar" data-sidebar aria-label="Navegação administrativa">
        ...
        <nav class="sidebar-nav" aria-label="Módulos">
            ...
            <?php if ($canMenu('evidence.checklist.manage') || $canMenu('evidence.upload')): ?><a href="<?= $e(App\Core\Config::url('/admin/dias-evento')) ?>"<?= $isActive('/admin/dias-evento') ? ' aria-current="page"' : '' ?>><span class="nav-icon" data-icon="calendar" aria-hidden="true">DE</span><span class="nav-label">Dias de evento</span></a><?php endif; ?>
