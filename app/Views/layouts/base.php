...
<div class="app-shell">
    <aside id="app-sidebar" class="app-sidebar" data-sidebar aria-label="Navegação administrativa">
        ...
        <nav class="sidebar-nav" aria-label="Módulos">
            ...
            <?php if ($canMenu('evidence.checklist.manage') || $canMenu('evidence.upload')): ?><a href="<?= $e(App\Core\Config::url('/admin/dias-evento')) ?>"<?= $isActive('/admin/dias-evento') ? ' aria-current="page"' : '' ?>><span class="nav-icon" data-icon="calendar-days" aria-hidden="true"></span><span class="nav-label">Dias de evento</span></a><?php endif; ?>
            ...
            <?php if (!$isAccountabilityOnly && $showSportGroup): ?><div class="sidebar-group sidebar-group--sport" data-sidebar-group="sport" data-active="<?= $sidebarGroupActive['sport'] ? 'true' : 'false' ?>">
                <button class="sidebar-group-toggle" type="button" data-sidebar-group-toggle aria-controls="sidebar-group-sport" aria-expanded="<?= $sidebarGroupActive['sport'] ? 'true' : 'false' ?>"><span class="sidebar-group-icon" data-icon="trophy" aria-hidden="true"></span><span>Equipes e atletas</span><span class="sidebar-chevron" data-icon="chevron-right" aria-hidden="true"></span></button>
