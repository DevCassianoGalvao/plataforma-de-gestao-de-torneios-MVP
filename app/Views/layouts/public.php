...
<body class="public-portal" data-portal-primary="<?= $e($championship['primary_color'] ?? '') ?>" data-portal-secondary="<?= $e($championship['secondary_color'] ?? '') ?>" data-portal-accent="<?= $e($championship['accent_color'] ?? '') ?>">
    <header class="portal-header">
        <div class="portal-header-inner">
            <a class="portal-brand" href="<?= $e($base) ?>">
                <?php if (!empty($championship['logo_path'])): ?><img src="<?= $e($base . '/assets/logo') ?>" alt="Logo de <?= $e($championship['name']) ?>"><?php endif; ?>
            ...
            <div class="portal-nav-tools">
                ...
                <button class="icon-button portal-nav-toggle" type="button" data-portal-nav-toggle aria-label="Abrir navegacao" aria-expanded="false" title="Abrir navegacao">=</button>
            </div>
            <nav class="portal-nav" data-portal-nav aria-label="Navegacao do campeonato">
                <a href="<?= $e($base) ?>">Inicio</a>
                <a href="<?= $e($base . '/proximos-jogos') ?>">Jogos</a>
                <a href="<?= $e($base . '/resultados') ?>">Resultados</a>
                <a href="<?= $e($base . '/classificacao') ?>">Classificacao</a>
                <a href="<?= $e($base . '/equipes') ?>">Equipes</a>
                <a href="<?= $e($base . '/noticias') ?>">Noticias</a>
    ...
    <footer class="portal-footer">
        ...
        <nav aria-label="Informacoes do campeonato"><a href="<?= $e($base . '/atletas') ?>">Atletas</a><a href="<?= $e($base . '/artilharia') ?>">Artilharia</a><a href="<?= $e($base . '/regulamento') ?>">Regulamento</a><a href="<?= $e($base . '/campeao') ?>">Campeao e vice</a></nav>
    </footer>
