<section>
    ...
    <h2>Checklist</h2>
    <ul class="checklist"><li class="done">Informações gerais</li><li class="<?= $championship['logo_path'] || $championship['primary_color'] !== '#123C32' ? 'done' : '' ?>">Identidade basica</li><li class="<?= $regulation && $regulation['status'] === 'published' ? 'done' : '' ?>">Regulamento</li><li class="<?= $assignments !== [] ? 'done' : '' ?>">Organizadores vinculados</li><li class="pending">Equipes — ainda não disponível</li><li class="pending">Partidas — ainda não disponível</li></ul>
    <h2>Status</h2>
