...
<section class="page-stack">
    <div class="section-heading">
        <div>
            ...
            <h1>Organizadores do campeonato</h1>
            <p class="muted"><?= $e($championship['name']) ?> · vincule quem poderá administrar integralmente este campeonato. O organizador não acessa configurações globais do sistema.</p>
        </div>
    ...
    <article class="panel">
        <h2>Vincular organizador</h2>
        <p class="muted">O usuário precisa estar ativo e possuir o perfil Organizador do campeonato. Crie o usuário e atribua o perfil em Usuários antes.</p>
        <form method="post" action="<?= $e(App\Core\Config::url('/admin/campeonatos/' . $championship['slug'] . '/organizadores')) ?>" class="inline-form">
