<section>
    <div class="section-heading"><div><p class="eyebrow">Acesso administrativo</p><h1>Usuarios</h1></div><a class="button" href="<?= App\Core\View::e(App\Core\Config::url('/admin/usuarios/novo')) ?>">Novo usuario</a></div>
    ...
    <div class="table-wrap"><table><thead><tr><th>Nome</th><th>E-mail</th><th>Status</th><th>Perfis</th><th>Ultimo acesso</th><th>Acoes</th></tr></thead><tbody>
    <?php foreach ($usersList as $record): ?>
        <tr>
            ...
            <td><?= App\Core\View::e($record['last_login_at'] ?: 'Ainda nao acessou') ?></td>
