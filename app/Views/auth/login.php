<div class="auth-screen">
    <section class="auth-visual" aria-label="Plataforma de gestao de torneios">
    ...
    <section class="auth-panel">
        <div class="auth-card">
            ...
            <p class="auth-footer">Plataforma de Gestao de Torneios MVP</p>
        </div>
    </section>
</div>
