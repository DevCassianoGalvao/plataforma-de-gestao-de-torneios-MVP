-- Repairs restored production databases whose migration history is ahead of
-- the physical schema. This migration is intentionally idempotent.
CREATE TABLE IF NOT EXISTS application_backup_settings (
    ...
    CONSTRAINT fk_backup_settings_updater_0047 FOREIGN KEY (updated_by) REFERENCES users (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT IGNORE INTO application_backup_settings (
    id, provider, schedule_enabled, schedule_time, schedule_interval_days, created_at, updated_at
