...
final class MigrationTest
{
    public static function run(): void
    {
        ...
        $backupMigration = in_array('0034_application_backups.sql', $first, true);
        if ($backupMigration) {
            array_pop($first);
        }
        ...
        assert_true($backupMigration, 'Migration de backups nao aplicada');
