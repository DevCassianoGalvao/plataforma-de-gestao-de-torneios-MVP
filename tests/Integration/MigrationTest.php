...
final class MigrationTest
{
    public static function run(): void
    {
        ...
        $backupMigrations = array_values(array_filter($first, static fn (string $migration): bool => str_starts_with($migration, '0034_') || str_starts_with($migration, '0035_') || str_starts_with($migration, '0039_') || str_starts_with($migration, '0042_') || str_starts_with($migration, '0043_')));
        ...
        assert_same(['0034_application_backups.sql', '0035_backup_settings.sql', '0039_backup_schedule_intervals.sql', '0042_regulation_copa_brasil_rules.sql', '0043_championship_guardian_policy.sql'], $backupMigrations, 'Migrations de extensao nao aplicadas');
