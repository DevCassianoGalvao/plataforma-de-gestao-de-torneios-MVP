...
final class AthleteTest
{
    public static function run(): void
    {
        ...
        $minorInAdultCategory = array_merge($valid, ['birth_date' => '2010-05-01']);
        assert_true(AthleteRules::validate($minorInAdultCategory, ['minimum_age' => 18, 'maximum_age' => null, 'gender_rule' => 'male']) !== [], 'Categoria adulta aceitou menor sem autorizacao do campeonato');
        assert_true(AthleteRules::validate($minorInAdultCategory, ['minimum_age' => 18, 'maximum_age' => null, 'gender_rule' => 'male', 'allow_underage_athletes' => 1]) === [], 'Categoria adulta nao aceitou menor com autorizacao do campeonato');
