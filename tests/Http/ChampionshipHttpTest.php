...
final class ChampionshipHttpTest
{
    public static function run(): void
    {
        ...
        assert_same(1, (int) $pdo->query("SELECT allow_underage_athletes FROM championships WHERE id = {$adminChampionshipId}")->fetchColumn(), 'Permissao de menores em categoria adulta nao foi salva');
