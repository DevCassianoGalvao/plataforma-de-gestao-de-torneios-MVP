...
final class ProductionReadinessHttpTest
{
    public static function run(): void
    {
        ...
        $auth = $router->dispatch(Request::fake('POST', '/copa-online/login', ['_csrf' => $csrf, 'email' => 'admin@torneios.local', 'password' => getenv('SEED_DEMO_PASSWORD') ?: 'TestDemo123', 'next' => '//evil.example']));
        ...
        $portal = $router->dispatch(Request::fake('GET', '/copa-online/campeonatos/copa-brasil-de-talentos-2026'));
