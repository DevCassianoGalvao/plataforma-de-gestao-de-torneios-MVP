...
final class ScheduleHttpTest
{
    public static function run(): void
    {
        ...
        assert_same(200, $router->dispatch(Request::fake('GET', '/torneio-online/admin/tabela'))->status, 'Tabela HTTP nao abriu');
        assert_same(200, $router->dispatch(Request::fake('GET', '/torneio-online/admin/fases'))->status, 'Fases HTTP nao abriram');
        ...
        $teamSchedule = $router->dispatch(Request::fake('GET', '/torneio-online/admin/tabela'));
        ...
        assert_same(403, $router->dispatch(Request::fake('GET', '/torneio-online/admin/partidas/' . $foreignId))->status, 'Treinador acessou partida de equipe alheia');
        self::logout($router);
    ...
    {
        assert_same(302, $router->dispatch(Request::fake('POST', '/torneio-online/logout', ['_csrf' => Security::csrfToken()]))->status, 'Logout de tabela falhou');
    }
}
