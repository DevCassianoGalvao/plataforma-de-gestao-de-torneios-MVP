...
final class DisciplineHttpTest
{
    public static function run(): void
    {
        ...
        $response = $router->dispatch(new Request('GET', '/torneio-online/admin/disciplina', ['championship_id' => (string) $championshipId]));
    ...
    {
        assert_same(302, $router->dispatch(Request::fake('POST', '/torneio-online/logout', ['_csrf' => Security::csrfToken()]))->status, 'Logout disciplinar falhou');
        Session::destroy();
    }
}
