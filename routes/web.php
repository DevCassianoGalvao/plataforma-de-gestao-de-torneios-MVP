...
use App\Http\Controllers\EvidenceChecklistController;
use App\Http\Controllers\EventDayController;
use App\Http\Controllers\MatchPublicationController;
...
use App\Http\Controllers\RoundMonitoringController;
...
$championshipCarousel = new ChampionshipCarouselRepository($pdo);
...
$eligibilityService = new EligibilityService(new EligibilityRepository($pdo), $audit);
...
$lineupService = new LineupService($lineups, $tacticalFormations, $teams, $authorization, $audit, $disciplineService, $eligibilityService, $athleteDocuments);
$operations = new MatchOperationRepository($pdo);
$matchMedia = new MatchMediaRepository($pdo);
$evidenceChecklist = new EvidenceChecklistRepository($pdo);
$eventDays = new EventDayRepository($pdo);
$matchPublications = new MatchPublicationRepository($pdo);
$matchPublicationService = new MatchPublicationService($matchPublications, $audit);
...
$operationService = new MatchOperationService($operations, $lineups, $audit, $disciplineService, $matchReportService, $competitionProgress, $matchMedia);
...
$transferService = new TransferService($transferRepository, $audit, $transferAccess, $regulationRepository);
$publicPortalRepository = new PublicPortalRepository($pdo);
$accountabilityRepository = new AccountabilityRepository($pdo);
$accountabilityExports = new AccountabilityExportService($accountabilityRepository, $storage, $audit);
$retentionRepository = new RetentionRepository($pdo);
$retentionService = new RetentionService($pdo, $retentionRepository, $audit);
$permanentDeletion = new PermanentDeletionService($pdo, $retentionRepository, $audit, $storage);
$roundMonitoringRepository = new RoundMonitoringRepository($pdo);
$roundMonitoringPackages = new RoundMonitoringPackageService($roundMonitoringRepository, $storage, $audit);
$simulationRepository = new SimulationRepository($pdo);
$simulationService = new SimulationService($simulationRepository, new StandingsCalculator(), $audit);
...
$auth = new AuthController($users, $authorization, $audit, $authService);
...
$accountability = new AccountabilityController($users, $authorization, $audit, $accountabilityRepository, $accountabilityExports, $storage);
...
$router->get('/prestacao/campeonatos/{id}/partidas/{matchId}', [$accountability, 'detail']);
$router->post('/prestacao/campeonatos/{id}/partidas/{matchId}/sumula-assinada', [$accountability, 'uploadSigned']);
$retention = new RetentionController($users, $authorization, $audit, $retentionRepository, $retentionService, $permanentDeletion);
$router->get('/admin/retencao', [$retention, 'index']);
$router->post('/admin/retencao/excluir-definitivamente', [$retention, 'purge']);
$router->post('/admin/retencao/{scope}', [$retention, 'save']);
$router->post('/admin/retencao/{entity}/{id}/arquivar', [$retention, 'archive']);
$router->post('/admin/retencao/{entity}/{id}/restaurar', [$retention, 'restore']);
$roundMonitoring = new RoundMonitoringController($users, $authorization, $audit, $roundMonitoringRepository, $storage, $roundMonitoringPackages);
$router->get('/admin/rodadas/acompanhamento', [$roundMonitoring, 'index']);
$router->get('/admin/rodadas/{id}/acompanhamento', [$roundMonitoring, 'show']);
$router->post('/admin/rodadas/{id}/acompanhamento/prazo', [$roundMonitoring, 'deadline']);
$router->get('/admin/rodadas/{id}/acompanhamento/exportar', [$roundMonitoring, 'export']);
$router->get('/admin/rodadas/{id}/acompanhamento/pacote', [$roundMonitoring, 'package']);
...
$userController = new UserController($users, $authorization, $audit);
...
$eligibilityController = new EligibilityController($users, $authorization, $audit, $schedules ?? new ScheduleRepository($pdo), new EligibilityRepository($pdo), $eligibilityService);
$router->post('/admin/partidas/{id}/elegibilidade/excecoes', [$eligibilityController, 'grant']);
...
$router->post('/admin/backups/{id}/reenviar', [$backupController, 'retry']);
$router->post('/admin/backups/{id}/excluir', [$backupController, 'delete']);
...
$evidence = new EvidenceChecklistController($users, $authorization, $audit, $evidenceChecklist);
$eventDay = new EventDayController($users, $authorization, $audit, $eventDays, $championships, $schedules, $storage);
$router->get('/admin/dias-evento', [$eventDay, 'index']);
$router->post('/admin/dias-evento', [$eventDay, 'create']);
$router->post('/admin/dias-evento/{id}/excluir', [$eventDay, 'delete']);
$router->post('/admin/dias-evento/{id}/evidencias', [$eventDay, 'upload']);
$router->get('/admin/dias-evento/{id}/evidencias/{mediaId}', [$eventDay, 'asset']);
$router->post('/admin/dias-evento/{id}/evidencias/{mediaId}/analise', [$eventDay, 'review']);
$router->post('/admin/dias-evento/{id}/evidencias/{mediaId}/excluir', [$eventDay, 'remove']);
$publication = new MatchPublicationController($users, $authorization, $audit, $schedules, $matchPublicationService);
$router->get('/minhas-partidas', [$operator, 'mine']);
$router->post('/admin/partidas/{id}/publicacao', [$publication, 'update']);
...
$router->get('/campeonatos/{slug}/carrossel/{id}/imagem', [$publicPortal, 'carouselAsset']);
...
$simulations = new SimulationController($users, $authorization, $audit, $simulationRepository, $simulationService);
$router->get('/admin/simulacoes', [$simulations, 'index']);
$router->get('/admin/simulacoes/nova', [$simulations, 'form']);
$router->post('/admin/simulacoes', [$simulations, 'create']);
$router->get('/admin/simulacoes/{id}', [$simulations, 'show']);
$router->post('/admin/simulacoes/{id}/referencias', [$simulations, 'addReference']);
$router->post('/admin/simulacoes/{id}/hipoteticas', [$simulations, 'hypothetical']);
$router->post('/admin/simulacoes/{id}/rodada', [$simulations, 'simulateRound']);
$router->post('/admin/simulacoes/{id}/partidas/{matchId}/placar', [$simulations, 'score']);
$router->post('/admin/simulacoes/{id}/partidas/{matchId}/restaurar', [$simulations, 'restore']);
$router->post('/admin/simulacoes/{id}/partidas/{matchId}/eventos', [$simulations, 'event']);
$router->post('/admin/simulacoes/{id}/duplicar', [$simulations, 'duplicate']);
$router->post('/admin/simulacoes/{id}/arquivar', [$simulations, 'archive']);
$router->post('/admin/simulacoes/{id}/excluir', [$simulations, 'delete']);

$championship = new ChampionshipController($users, $authorization, $audit, $championships, $championshipCarousel, $seasons, $categories, $access, $statusService, $regulationService, $storage, $users);
...
$router->get('/admin/campeonatos/{slug}/organizadores', [$championship, 'organizers']);
$router->post('/admin/campeonatos/{slug}/organizadores', [$championship, 'assignOrganizer']);
$router->post('/admin/campeonatos/{slug}/organizadores/{userId}/encerrar', [$championship, 'unassignOrganizer']);
...
$router->get('/admin/campeonatos/{slug}/evidencias', [$evidence, 'index']);
$router->post('/admin/campeonatos/{slug}/evidencias', [$evidence, 'save']);
$router->post('/admin/campeonatos/{slug}/evidencias/{id}/situacao', [$evidence, 'toggle']);
$router->post('/admin/campeonatos/{slug}/evidencias/{id}/excluir', [$evidence, 'delete']);
